...
def start_session():
    ...
    # Check access codes
    access_code = content.get('accessCode', None)
...
def query():
    ...
    context_window_size = get_context_window_size("gpt-4")
    ...
    try:
        ...
        for choice in response.choices:
            ...
            #     choice.message.content,  # 提取生成的内容
    ...
    results['status'] = SUCCESS
    results['original_suggestions'] = suggestions
    results['suggestions_with_probabilities'] = suggestions
    results['ctrl'] = {
        'n': n,
        'max_tokens': max_tokens,
        'temperature': temperature,
    ...
    results['counts'] = len(suggestions)
